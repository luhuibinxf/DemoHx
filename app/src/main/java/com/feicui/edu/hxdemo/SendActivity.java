...
public class SendActivity extends AppCompatActivity implements EMMessageListener {
    // 聊天信息输入框
    ...
    private void initConversation() {
        ...
        if (mConversation.getAllMessages().size() > 0) {
            ...
            // 将消息内容和时间显示出来
            mContentText.setText("聊天记录：" + body.getMessage() + " - time: " +
