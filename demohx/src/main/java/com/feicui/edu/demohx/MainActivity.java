...
import com.feicui.edu.demohx.ui.ChatActivity;
import com.feicui.edu.demohx.ui.SettingsFragment;
...
import com.feicui.edu.demohx.R;
        ...
        conversationListFragment.setConversationListItemClickListener(new EaseConversationListItemClickListener() {
            ...
            public void onListItemClicked(EMConversation conversation) {
                startActivity(new Intent(MainActivity.this, ChatActivity.class).
                        putExtra(EaseConstant.EXTRA_USER_ID, conversation.getUnreadMsgCount()));
            }
        });
